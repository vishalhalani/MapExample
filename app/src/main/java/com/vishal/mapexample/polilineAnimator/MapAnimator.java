...
public class MapAnimator {
    ...
    public void animateRoute(GoogleMap googleMap, List<LatLng> routeList) {
        ...
        PolylineOptions optionsBackground = new PolylineOptions().add(routeList.get(0)).color(GREY).width(5);
        backgroundPolyline = googleMap.addPolyline(optionsBackground);

        optionsForeground = new PolylineOptions().add(routeList.get(0)).color(Color.BLACK).width(5);
